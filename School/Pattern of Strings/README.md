<h2><a href="https://practice.geeksforgeeks.org/problems/pattern-of-strings3829/1?page=1&difficulty[]=-2&category[]=Strings&sortBy=difficulty">Pattern of Strings</a></h2><h3>Difficulty Level : School</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a string <strong>S</strong> of length <strong>N</strong>, find the pattern of the strings as shown below in the examples.</span></p>
