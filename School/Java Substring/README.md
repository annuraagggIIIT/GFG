<h2><a href="https://practice.geeksforgeeks.org/problems/java-substring5058/1?page=2&difficulty[]=-2&category[]=Strings&sortBy=difficulty">Java Substring</a></h2><h3>Difficulty Level : School</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a string <strong>S</strong> and two integers <strong>L</strong> and <strong>R</strong>. Print the characters in the range <strong>L</strong> to <strong>R</strong> of the string.<br>
