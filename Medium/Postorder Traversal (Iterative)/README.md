<h2><a href="https://practice.geeksforgeeks.org/problems/postorder-traversal-iterative/1?page=1&category[]=Tree&category[]=Binary%20Search%20Tree&sortBy=accuracy">Postorder Traversal (Iterative)</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a binary tree. Find the postorder traversal of the tree <strong>without using recursion</strong>.</span></p>
