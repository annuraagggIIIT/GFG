<h2><a href="https://practice.geeksforgeeks.org/problems/sort-a-string2943/1?page=1&difficulty[]=-1&category[]=Strings&sortBy=difficulty">Sort a String</a></h2><h3>Difficulty Level : Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a string consisting of lowercase letters, arrange all its letters in ascending order.&nbsp;</span></p>
