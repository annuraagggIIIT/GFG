<h2><a href="https://practice.geeksforgeeks.org/problems/shortest-path-from-1-to-n0156/1?page=1&difficulty[]=-1&category[]=Graph&sortBy=accuracy">Shortest path from 1 to n</a></h2><h3>Difficulty Level : Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Consider a directed graph whose vertices are numbered from 1 to n. There is an edge from a vertex i to a vertex j iff either j = i + 1 or j = 3 * i. The task is to find the minimum number of edges in a path in G from vertex 1 to vertex n.</span></p>
