<h2><a href="https://practice.geeksforgeeks.org/problems/bae68b4d6a2a77fb6bd459cf7447240919ebfbf5/1?page=2&difficulty[]=0&category[]=Linked%20List&sortBy=submissions">Reverse both parts</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a linked list and a number k. You have to reverse first part of linked list with k nodes and the second part with n-k nodes.</span></p>
