<h2><a href="https://practice.geeksforgeeks.org/problems/max-and-min-element-in-binary-tree/1?page=3&difficulty[]=0&category[]=Tree&category[]=Binary%20Search%20Tree&sortBy=submissions">Max and min element in Binary Tree</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a Binary Tree, find maximum and minimum elements in it.</span></p>
