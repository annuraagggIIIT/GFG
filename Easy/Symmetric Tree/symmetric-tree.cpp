...
class Solution {
public:
    // Helper function to check whether two subtrees are symmetric
    bool isSymmetricHelper(Node* leftSubtree, Node* rightSubtree) {
        // If both subtrees are empty, they are symmetric
        if (leftSubtree == nullptr && rightSubtree == nullptr)
            return true;

        // If one of the subtrees is empty but the other is not, they are not symmetric
        if (leftSubtree == nullptr || rightSubtree == nullptr)
            return false;
        ...
        // Recursively check if the left subtree of the left tree is symmetric to the right subtree of the right tree
    ...
    // Function to check whether the binary tree is symmetric
