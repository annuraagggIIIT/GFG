<h2><a href="https://practice.geeksforgeeks.org/problems/max-level-sum-in-binary-tree/1?page=1&difficulty[]=0&status[]=unsolved&category[]=Tree&category[]=Binary%20Search%20Tree&sortBy=submissions">Max Level Sum in Binary Tree</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a Binary Tree having positive and negative nodes. Find the maximum sum of a level in the given Binary Tree.</span></p>
