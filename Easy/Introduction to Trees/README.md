<h2><a href="https://practice.geeksforgeeks.org/problems/introduction-to-trees/1?page=1&sortBy=accuracy">Introduction to Trees</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given an integer <strong>i</strong>. Print the <strong>maximum number of nodes</strong> on level i of a binary tree.</span></p>
